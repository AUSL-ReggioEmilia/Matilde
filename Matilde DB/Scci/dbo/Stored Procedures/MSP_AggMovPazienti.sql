CREATE PROCEDURE [dbo].[MSP_AggMovPazienti](@xParametri XML)
AS
BEGIN
		...
		DECLARE @uID AS UNIQUEIDENTIFIER					DECLARE @uIDEpisodio AS UNIQUEIDENTIFIER	
	...
	DECLARE @xParLog AS XML
		...
		SET @sSQL='UPDATE T_MovPazienti ' + CHAR(13) + CHAR(10) +
			  'SET '  				  						
