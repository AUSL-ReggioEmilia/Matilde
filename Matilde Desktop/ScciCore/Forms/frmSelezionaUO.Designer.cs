namespace UnicodeSrl.ScciCore
{
    partial class frmSelezionaUO
    {
                                        ...
                                        private void InitializeComponent()
        {
            ...
            this.Name = "frmSelezionaUO";
            this.PulsanteAvantiVisibile = true;
            this.PulsanteIndietroVisibile = true;
            this.Text = "frmSelezionaUO";
            this.PulsanteIndietroClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUO_PulsanteIndietroClick);
            this.PulsanteAvantiClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUO_PulsanteAvantiClick);
