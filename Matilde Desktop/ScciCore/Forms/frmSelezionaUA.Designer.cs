namespace UnicodeSrl.ScciCore
{
    partial class frmSelezionaUA
    {
                                        ...
                                        private void InitializeComponent()
        {
            ...
            this.Name = "frmSelezionaUA";
            this.PulsanteAvantiVisibile = true;
            this.PulsanteIndietroVisibile = true;
            this.Text = "frmSelezionaUA";
            this.PulsanteIndietroClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUA_PulsanteIndietroClick);
            this.PulsanteAvantiClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUA_PulsanteAvantiClick);
