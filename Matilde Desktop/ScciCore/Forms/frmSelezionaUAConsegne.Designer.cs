...
{
    partial class frmSelezionaUAConsegne
    {
                                        ...
                                        private void InitializeComponent()
        {
            ...
            this.Name = "frmSelezionaUAConsegne";
            this.PulsanteAvantiVisibile = true;
            this.PulsanteIndietroVisibile = true;
            this.Text = "frmSelezionaUAConsegne";
            this.PulsanteIndietroClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUAConsegne_PulsanteIndietroClick);
            this.PulsanteAvantiClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaUAConsegne_PulsanteAvantiClick);
