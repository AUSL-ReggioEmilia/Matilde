...
namespace UnicodeSrl.ScciCore
{
    public partial class frmInfo : Form
    {
        ...
        public delegate void DoWorkEventHandler(frmInfo sender, DoWorkEventArgs e);
        ...
        public UnicodeSrl.SmartCard.SCStatus.SmartCardStatusEnum Stato
        {
            get
            {
                if (_SCHandler != null)
                    return _SCHandler.CurrentSCStatus.SmartCardStatus;
                else
                    return SmartCard.SCStatus.SmartCardStatusEnum._undefined;
            }
        ...
        private void InitSCHandler()
        {
            try
            {
                ...
                _SCHandler.SCStatusChanged += _SCHandler_SCStatusChanged;
                                ...
                                showSCStatus(_SCHandler.CurrentSCStatus);
            }
            catch (Exception ex)
            {
        ...
        private void _SCHandler_SCStatusChanged(object sender, UnicodeSrl.SmartCard.SCStatusChangedEventArgs e)
        {
            if (this.InvokeRequired)
            {
                ...
                showSCStatus(e.SCStatus);
        }

        delegate void showSCStatusDelegate(UnicodeSrl.SmartCard.SCStatus scstatus);

        private void showSCStatus(UnicodeSrl.SmartCard.SCStatus scstatus)
        {
            try
            {
                string sMsg = "";
