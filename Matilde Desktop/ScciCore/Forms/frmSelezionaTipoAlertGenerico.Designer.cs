...
{
    partial class frmSelezionaTipoAlertGenerico
    {
                                        ...
                                        private void InitializeComponent()
        {
            ...
            this.Name = "frmSelezionaTipoAlertGenerico";
            this.PulsanteAvantiVisibile = true;
            this.PulsanteIndietroVisibile = true;
            this.Text = "frmSelezionaTipoAlertGenerico";
            this.PulsanteIndietroClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaTipoAlertGenerico_PulsanteIndietroClick);
            this.PulsanteAvantiClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaTipoAlertGenerico_PulsanteAvantiClick);
