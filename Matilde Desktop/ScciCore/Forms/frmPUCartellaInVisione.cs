...
{
    public partial class frmPUCartellaInVisione : frmBaseModale, Interfacce.IViewFormlModal
    {

        public frmPUCartellaInVisione()
        {
            InitializeComponent();
        }
        ...
        private void InizializzaControlli()
        {
            ...
            try
            {
                ...
                if (this.ucEasyGridRuoli.Rows.Count > 0)
                {
                    ...
                    CoreStatics.SelezionaRigaInGriglia(ref ucEasyGridRuoli, "Codice", CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.CodRuoloInVisione);
                }

                this.udteDataOraInizio.Value = CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataInizio;
                this.udteDataOraFine.Value = CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataFine;
        ...
        public bool Salva()
        {
            ...
            try
            {
                ...
                if (ControllaValori())
                {
                    ...
                    CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.CodRuoloInVisione = this.ucEasyGridRuoli.ActiveRow.Cells["Codice"].Text;
                    CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataInizio = (DateTime)this.udteDataOraInizio.Value;
                    CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataFine = (DateTime)this.udteDataOraFine.Value;

                    bReturn = CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.Salva();
        ...
        public bool ControllaValori()
        {
            ...
            {
                easyStatics.EasyMessageBox("Selezionare un Ruolo.", "Cartella in Visione", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            {
                easyStatics.EasyMessageBox("E' necessario definire Data/Ora Inizio.", "Cartella in Visione", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                this.udteDataOraInizio.Focus();
                bOK = false;
            }
            if (bOK && this.udteDataOraFine.Value == null)
            {
                easyStatics.EasyMessageBox("E' necessario definire Data/Ora Fine.", "Cartella in Visione", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                this.udteDataOraFine.Focus();
                bOK = false;
            }
            if (bOK && (DateTime)this.udteDataOraFine.Value <= (DateTime)this.udteDataOraInizio.Value)
            {
                easyStatics.EasyMessageBox("Date non coerenti: Data/Ora Inizio maggiore o uguale di Data/Ora Fine.", "Cartella in Visione", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                this.udteDataOraFine.Focus();
                bOK = false;
            }
        ...
        private void frmPUCartellaInVisione_ImmagineClick(object sender, ImmagineTopClickEventArgs e)
        {
        ...
        private void frmPUCartellaInVisione_PulsanteAvantiClick(object sender, PulsanteBottomClickEventArgs e)
        {
        ...
        private void frmPUCartellaInVisione_PulsanteIndietroClick(object sender, PulsanteBottomClickEventArgs e)
        {
            this.DialogResult = System.Windows.Forms.DialogResult.Cancel;
            this.Close();
        }

        private void frmPUCartellaInVisione_Shown(object sender, EventArgs e)
        {
        ...
        private void ucEasyGridRuoli_AfterRowActivate(object sender, EventArgs e)
        {

            try
            {
               
                using (ScciCommon.Model.T_AssRuoliAzioni o_ass = new ScciCommon.Model.T_AssRuoliAzioni())
                {

                    o_ass.CodRuolo = CoreStatics.CoreApplication.Sessione.Utente.Ruoli.RuoloSelezionato.Codice;
                    o_ass.CodEntita = EnumEntita.CIV.ToString();
                    o_ass.CodVoce = this.ucEasyGridRuoli.ActiveRow.Cells["Codice"].Text;
                    o_ass.CodAzione = EnumAzioni.INS.ToString();
                    o_ass.Select();

                    CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataFine = CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataInizio.AddDays(o_ass.ParametriCIV.GGCartelleInVisione);
                    this.udteDataOraFine.Value = CoreStatics.CoreApplication.MovCartellaInVisioneSelezionata.DataFine;
