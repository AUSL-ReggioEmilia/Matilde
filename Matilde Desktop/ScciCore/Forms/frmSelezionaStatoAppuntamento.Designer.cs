...
{
    partial class frmSelezionaStatoAppuntamento
    {
                                        ...
                                        private void InitializeComponent()
        {
            ...
            this.Name = "frmSelezionaTipoAppuntamento";
            this.PulsanteAvantiVisibile = true;
            this.PulsanteIndietroVisibile = true;
            this.Text = "frmSelezionaTipoAppuntamento";
            this.PulsanteIndietroClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaStatoAppuntamento_PulsanteIndietroClick);
            this.PulsanteAvantiClick += new UnicodeSrl.ScciCore.PulsanteBottomClickHandler(this.frmSelezionaStatoAppuntamento_PulsanteAvantiClick);
